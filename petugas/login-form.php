...
<html lang="en" data-textdirection="ltr" class="loading">
    <head>
        ...
        <title>Login - Aplikasi Antrian Pengunjung <?php echo $nama_instansi; ?></title>
                        ...
                        <div class="col-md-4 offset-md-4 col-xs-10 offset-xs-1  box-shadow-2 p-0">
                            <div class="card border-grey border-lighten-3 m-0">
                                <div class="card-header no-border">
                                    <div class="card-title text-xs-center">
                                        <div class="p-1">
                                            ...
                                            <h4 style="margin-bottom:0">APLIKASI ANTRIAN PENGUNJUNG</h4>
                                ...
                                <div class="card-footer">
                                    <!-- <center>&copy; 2019 - <a href="http://<?php echo $website; ?>"><?php echo $nama_instansi; ?></a></center> -->
                                    <center>&copy; 2024 - <a href="http://www.xbxteam.web.id">ELABS TELKOMEDIKA</a></center>
                                </div>
                            </div>
                        </div>
                    </section>
