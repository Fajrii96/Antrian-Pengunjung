        ...
        <body data-open="click" data-menu="vertical-menu" data-col="2-columns" class="vertical-layout vertical-menu 2-columns  fixed-navbar">
                    ...
                    <div class="navbar-header">
                        <ul class="nav navbar-nav">
                            ...
                            if ($_SESSION['antrian_user_permissions']=='Administrator') { ?>
                                <a href="beranda" class="navbar-brand nav-link"><img alt="branding logo" src="assets/images/logo/Logo.png" data-expand="assets/images/logo/Logo.png" data-collapse="assets/images/logo/favicon.ico" class="brand-logo"></a>
                            <?php
                            } else { ?>
                                <a href="antrian" class="navbar-brand nav-link"><img alt="branding logo" src="assets/images/logo/Logo.png" data-expand="assets/images/logo/Logo.png" data-collapse="assets/images/logo/favicon.ico" class="brand-logo"></a>
                            <?php
                            }
                            ?>
                            </li>
            ...
            <footer class="footer footer-static footer-light navbar-border">
                <p class="clearfix text-muted text-sm-center mb-0 px-2">
                    ...
                    <span class="float-md-left d-xs-block d-md-inline-block">Copyright  &copy; 2024 - <a href="www.xbxteam.co.id" target="_blank" class="text-bold-500 grey darken-2">ELABS TELKOMEDIKA</a></span>
                </p>
            </footer>
