...
<html lang="en">
	...
	<body class="no-skin">
		...
		<div class="main-container" id="main-container">
			...
			<div style="color:#000000" class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120 pull-left">
							<!-- &copy; 2024 - <a style="color:#E5E5E5" href="http://<?php echo $website; ?>"><?php echo $nama_instansi; ?></a> -->
							&copy; 2024 - <a style="color:#000000" href="https://telkomedika.co.id/telkomedika.co.id/index.html">ELABS TELKOMEDIKA</a>
						</span>
					</div>
				</div>
			</div>
